...
#save(lda_final_iters, file="lda_final_iters_fromtop50.RData") 
...
colnames(Gamma_lda)=c("Class 1","Class 2","Class 3")
...
pred1[which(pred=="Topic2")]="Healthy"
pred1[which(pred=="Topic3")]="Infection"
